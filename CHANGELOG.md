...
All bundles in src/ have been move to seperate bundles. These will be imported
  ...
  - os2display/media-bundle: Contains media code.
...
* See [admin/UPGRADELOG.md](https://github.com/os2display/admin/blob/development/UPGRADELOG.md) for instructions to upgrade.
